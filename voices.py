VOICES = [
  { "id": "com.apple.speech.synthesis.voice.Victoria", "lang": "en_US" },
  { "id": "com.apple.speech.synthesis.voice.kyoko", "lang": "ja_JP" },
  { "id": "com.apple.speech.synthesis.voice.monica", "lang": "es_ES" }
]
# [u'it_IT']
